...
import com.dbdemo.DBApplication;
...
public class GreenDaoContext extends ContextWrapper {
    ...
    private String currentUserId = "dbd";
    private Context mContext;

    public GreenDaoContext() {
        super(DBApplication.context);
        this.mContext = DBApplication.context;
    }
    ...
    public File getDatabasePath(String dbName) {
        String dbDir = Environment.getExternalStorageDirectory().getPath() + "/dbd";
